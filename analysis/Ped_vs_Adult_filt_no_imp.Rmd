...
unique_name <- paste0("Unique_", "adult_vs_ped")
...
if(leng_dep != 0){
  ...
  if(n_edge != 0){
    ...
    if(file.exists(here::here(paste0("output/network_FC_pvalue", test, ".png")))){
      file.remove(here::here(paste0("output/network_FC_pvalue", test, ".png")))
      } 
    
    exportImage(filename = here::here(paste0("output/network_FC_pvalue", test, ".png")), 'PNG', zoom=300)
    
    file.copy(from = here::here(paste0("output/network_FC_pvalue", test, ".png")), to = here::here(paste0("docs/assets/network_FC_pvalue", test, ".png")), overwrite = T)
  }else{
  print("NOT enough data.")
  }
...
if(n_edge != 0){
  knitr::include_graphics(paste0("assets/network_FC_pvalue", test, ".png"),  error = F)
}else{
  print("NOT enough data.")
}
```
...
if(enrich_map){
  ...
  if(file.exists(here::here(paste0("output/network_enrichmentmap", test, ".png")))){
      file.remove(here::here(paste0("output/network_enrichmentmap", test, ".png")))
      }

  exportImage(filename = here::here(paste0("output/network_enrichmentmap", test, ".png")), 'PNG', zoom=300)

  file.copy(from = here::here(paste0("output/network_enrichmentmap", test, ".png")), to = here::here(paste0("docs/assets/network_enrichmentmap", test, ".png")), overwrite = T)
...
if(enrich_map){
  knitr::include_graphics(paste0("assets/network_enrichmentmap", test, ".png"),  error = F)
}else{
  print("NOT enough data.")
}
```
...
```{r excel}
saveWorkbook(excel, here::here(paste0("output/results_table_", test, "_filt_no_imp.xlsx")), overwrite = T)
```
